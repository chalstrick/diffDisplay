...
public class TestSelectableSegmentedText {
  ...
  private int getLineIndexRelativeToSegmentedText(final SelectableSegmentedText text, final Segment segment, final int lineIndex)
      throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private int getLineIndex(final SelectableSegmentedText text, final Segment segment) throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private int getOffsetRelativeToSegment(final SelectableSegmentedText text, final Segment segment, final int offset) throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private int getOffset(final SelectableSegmentedText text, final Segment segment) throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private Segment findSegmentByOffset(final SelectableSegmentedText text, final int offset) throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private int getLineIndexRelativeToSegment(final SelectableSegmentedText text, final Segment segment, final int lineIndex)
      throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private Segment findSegmentByLineIndex(final SelectableSegmentedText text, final int lineIndex) throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private int getOffsetRelativeToSegmentedText(final SelectableSegmentedText text, final Segment segment, final int offset)
      throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private Segment findSegment(final SelectableSegmentedText text, final Point point) throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  private int isSegmentHere(final SelectableSegmentedText text, final Segment segment, final Point point) throws Throwable {
