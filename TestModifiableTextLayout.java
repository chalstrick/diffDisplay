...
public class TestModifiableTextLayout {
  ...
  public void testSetText() {    
    ModifiableTextLayout text = new ModifiableTextLayout(display);
    try {
  ...
  private void assertBounds(int expectedX, int expectedY, int expectedWidth, int expectedHeight, Rectangle actualBounds) {
    Rectangle expectedBounds = new Rectangle(expectedX, expectedY, expectedWidth, expectedHeight);
  ...
  private int getEndOfLineOffset(ModifiableTextLayout text, int lineIndex) throws Throwable {
