...
public class TestSelectableModifiableTextLayout {
  ...
  private void checkLineHeight(SelectableTextLayout text, int lineIndex, int expectedLineHeight) {    
  ...
  private void checkLocation(SelectableTextLayout text, int offset, int expectedX, int expectedY, boolean trailing) {    
    Point location = text.getLocation(offset, trailing);
    Point expectedLocation = new Point(expectedX, expectedY);
    assertTrue("Expected location [" + expectedLocation + "] for text [" + text .getText() + "] at offset [" + offset + "]; trailing = [" + trailing + "]; location = [" + location + "]", expectedLocation.equals(location));
  }
  ...
  public void testSelectionChangedListener() {
    ...
    try {
      text.append("0123456789");
      VerifyingSelectionChangedListener<SelectableTextLayout> selectionChangedListener = new VerifyingSelectionChangedListener<SelectableTextLayout>(text, new Rectangle(0, 0, 6, 13), null);
      ...
      VerifyingSelectionChangedListener<SelectableTextLayout> selectionChangedListener2 = new VerifyingSelectionChangedListener<SelectableTextLayout>(text, new Rectangle(0, 0, 6 * 6, 13), new Rectangle(0, 0, 6, 13));
      ...
      VerifyingSelectionChangedListener<SelectableTextLayout> selectionChangedListener3 = new VerifyingSelectionChangedListener<SelectableTextLayout>(text, null, new Rectangle(0, 0, 6 * 6, 13));
